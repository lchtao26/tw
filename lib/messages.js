...
export function formatDevLaunched(editor, folderPath) {
  return `  → launched ${editor} → ${formatDisplayPath(folderPath)}`;
}

export function formatDevNoEditorYet() {
  return '  → no editor yet — press e first';
}
