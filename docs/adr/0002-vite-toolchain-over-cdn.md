...
> _Superseded by [ADR-0003](./0003-tailwind-via-browser-cdn.md), then restored by [ADR-0006](./0006-vite-dev-server-minimal.md). The decision recorded here is current again._
